      ...
      <BlockStack gap="400">
        <InlineStack align="space-between">
          ...
          {!isUnlimited && percentage >= 75 && (
            <Badge tone={tone}>{percentage >= 90 ? "Low Credits" : "Monitor Usage"}</Badge>
          )}
        </InlineStack>
        ...
        {isUnlimited ? (
          <BlockStack gap="300">
            ...
            <Text tone="subdued">Your plan includes unlimited credits for selfie processing.</Text>
          </BlockStack>
        ) : (
          <BlockStack gap="300">
            <BlockStack gap="200">
              <InlineStack align="space-between">
                ...
                <Text tone="subdued">{remaining.toLocaleString()} remaining</Text>
              </InlineStack>
              <ProgressBar progress={percentage} tone={tone} size="small" />
            </BlockStack>

            <InlineStack align="space-between">
              <Text tone="subdued">{Math.round(percentage)}% used this period</Text>
              {daysUntilReset && (
                <Text tone="subdued">
            ...
            {percentage >= 100 && (
              <BlockStack gap="200">
                <Banner tone="critical">
                  <Text>
                    Credit limit reached. New selfie requests will be blocked until your credits
                    reset
        ...
        {!isUnlimited && (
          <InlineStack gap="200">
            ...
            {percentage >= 75 && <Button plain>Set up usage alerts</Button>}
          </InlineStack>
        )}
      </BlockStack>
    </Card>
