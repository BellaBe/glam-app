...
class ServiceConfig(BaseModel):
    ...
    season_compatibility_url: str = Field(
        default="http://season-compatibility-service:8000", alias="SEASON_COMPATIBILITY_URL"
    )
...
def get_service_config() -> ServiceConfig:
    ...
    try:
        ...
        raise ConfigurationError(f"Failed to load config: {e}", config_key="recommendation-service")
