...
class ServiceLifecycle:
    ...
    def __init__(self, config: ServiceConfig, logger: ServiceLogger):
        ...
        # Repositories
        self.billing_repo: Optional[BillingRepository] = None
        self.purchase_repo: Optional[PurchaseRepository] = None
        
        # Services
        self.billing_service: Optional[BillingService] = None
        self.purchase_service: Optional[PurchaseService] = None
        
        # Utils
        self.pack_manager: Optional[CreditPackManager] = None
