...
class CreditPackManager:
    ...
    def __init__(self, config: ServiceConfig):
        self.packs = {
            CreditPack.SMALL: {
                "credits": config.small_pack_credits,
                "price": config.small_pack_price
            },
            CreditPack.MEDIUM: {
                "credits": config.medium_pack_credits,
                "price": config.medium_pack_price
            },
            CreditPack.LARGE: {
                "credits": config.large_pack_credits,
                "price": config.large_pack_price
            }
        }
    
    def get_pack(self, pack_type: CreditPack) -> Optional[Dict]:
