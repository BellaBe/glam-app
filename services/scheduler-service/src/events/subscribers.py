...
class CreateScheduleSubscriber(SchedulerEventSubscriber):
    ...
    subject = SchedulerCommands.SCHEDULE_CREATE
    ...
    async def handle(self, data: Dict[str, Any], context: EventContext) -> None:
        ...
        try:
            ...
            self.logger.error(
                f"Invalid payload for {self.subject}",
                extra={**context.to_dict(), "validation_errors": e.errors()},
            )
            raise
        except Exception as e:
            self.logger.error(
                f"Failed to create schedule",
                extra={**context.to_dict(), "error": str(e)},
            )
            raise
...
class UpdateScheduleSubscriber(SchedulerEventSubscriber):
    ...
    subject = SchedulerCommands.SCHEDULE_UPDATE
    ...
    async def handle(self, data: Dict[str, Any], context: EventContext) -> None:
        ...
        try:
            ...
            self.logger.info(
                ...
                extra={**context.to_dict(), "schedule_id": str(payload.schedule_id)},
            )
            ...
            self.logger.info(
                ...
                extra={**context.to_dict(), "schedule_id": str(schedule.id)},
            )
...
class DeleteScheduleSubscriber(SchedulerEventSubscriber):
    ...
    subject = SchedulerCommands.SCHEDULE_DELETE
...
class PauseScheduleSubscriber(SchedulerEventSubscriber):
    ...
    subject = SchedulerCommands.SCHEDULE_PAUSE
...
class ResumeScheduleSubscriber(SchedulerEventSubscriber):
    ...
    subject = SchedulerCommands.SCHEDULE_RESUME
...
class TriggerScheduleSubscriber(SchedulerEventSubscriber):
    ...
    subject = SchedulerCommands.SCHEDULE_TRIGGER
...
class ExecuteImmediateSubscriber(SchedulerEventSubscriber):
    ...
    subject = SchedulerCommands.EXECUTE_IMMEDIATE
    ...
    async def handle(self, data: Dict[str, Any], context: EventContext) -> None:
        ...
        try:
            ...
            self.logger.info(
                ...
                extra={**context.to_dict(), "target_command": payload.target_command},
            )
