...
from .events.listeners import AnalysisCompletedListener
...
class ServiceLifecycle:
    ...
    def __init__(self, config: ServiceConfig, logger: ServiceLogger):
        ...
        # Components
        self.event_publisher: Optional[SelfieEventPublisher] = None
        self.analysis_repo: Optional[AnalysisRepository] = None
        self.image_processor: Optional[ImageProcessor] = None
        self.selfie_service: Optional[SelfieService] = None
    ...
    async def _init_messaging(self) -> None:
        ...
        self.event_publisher = SelfieEventPublisher(
