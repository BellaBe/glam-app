...
from shared.api.dependencies import ClientAuthContext, LoggerDep, PaginationDep, PlatformContextDep, RequestContextDep
...
def require_extended_client_auth(request: Request) -> ExtendedClientAuthContext:
    ...
    try:
        ...
        raise HTTPException(status_code=401, detail=f"Invalid JWT: {e!s}")
