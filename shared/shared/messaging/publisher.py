# Simplified version with just event-based classes
...
class JetStreamEventPublisher(ABC):
    ...
    async def publish_command(self, command_type: str, payload: Dict[str, Any], **kwargs) -> str:
        ...
        return await self.publish_event(event_type=command_type, payload=payload, **kwargs)
    ...
    async def publish_event_response(self, event_type: str, payload: Dict[str, Any], **kwargs) -> str:
        ...
        return await self.publish_event(event_type=event_type, payload=payload, **kwargs)
